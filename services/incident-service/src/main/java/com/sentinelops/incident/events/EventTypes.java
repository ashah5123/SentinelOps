...
public final class EventTypes {
  ...
  public static final String ALERT_INGESTED_V1 = "alert.ingested.v1";
  ...
  public static final String ALERT_INGESTED_V1_DLQ = "alert.ingested.v1.dlq";

  public static final int INCIDENT_DETECTED_SCHEMA_VERSION = 1;
  public static final int AUDIT_EVENT_SCHEMA_VERSION = 1;
  public static final int ALERT_INGESTED_SCHEMA_VERSION = 1;
