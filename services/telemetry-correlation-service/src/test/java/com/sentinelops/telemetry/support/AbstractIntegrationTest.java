 ...
 * against real PostgreSQL and Kafka-compatible Testcontainers instances. Mirrors the incident
 * service's own {@code AbstractIntegrationTest}.
 */
  ...
  static void createTopics() throws ExecutionException, InterruptedException {
    try (AdminClient adminClient =
      ...
      List<NewTopic> topics =
          List.of(
              new NewTopic(EventTypes.DEPLOYMENT_CHANGED_V1, 1, (short) 1),
              new NewTopic(EventTypes.SERVICE_DEPENDENCY_CHANGED_V1, 1, (short) 1),
              new NewTopic(EventTypes.INCIDENT_DETECTED_V1, 1, (short) 1),
              new NewTopic(EventTypes.INCIDENT_EVIDENCE_CORRELATED_V1, 1, (short) 1),
              new NewTopic(EventTypes.DEPLOYMENT_CHANGED_V1_DLQ, 1, (short) 1),
              new NewTopic(EventTypes.SERVICE_DEPENDENCY_CHANGED_V1_DLQ, 1, (short) 1),
